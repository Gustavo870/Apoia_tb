...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Ago-2026 às 22:45
...
--
ALTER TABLE `anuncios`
  MODIFY `IdAnuncio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de tabela `usuario`
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
